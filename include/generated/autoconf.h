...
#define CONFIG_CMDLINE "root=/dev/mtdblock2 console=ttyS2,115200 rootfstype=ext4 rootwait rootflags=noatime init=/sbin/init loglevel=8  mtdparts=rk29xxnand:0x00008000@0x00002000(boot),0x00008000@0x0000A000(kernel),-@0x00012000(system)"
